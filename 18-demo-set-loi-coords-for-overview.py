...
async def process():
    ...
    for i in range(0, 26):
        ...
        cv2.line(image, (0, i * 100), (2600, i * 100), (100, 100, 100), 1)
        cv2.putText(image, str(i), (10, i * 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (100, 100, 100), 2, cv2.LINE_AA)

    for i in range(0, 26):
        # draw a line across the image
        cv2.line(image, (i * 100, 0), (i * 100, 2000), (100, 100, 100), 1)
        cv2.putText(image, str(i), (i * 100, 10), cv2.FONT_HERSHEY_SIMPLEX, 1, (100, 100, 100), 2, cv2.LINE_AA)
